...
def search():
    return render_template("ricerca1.html")
...
def result():
    ...
    print(df_sales)
    if  df_sales.values.tolist() == []:
         return render_template('error1.html')
    else:
        return render_template('result1.html', nomiColonne = df_sales.columns.values, dati = list(df_sales.values.tolist()))
